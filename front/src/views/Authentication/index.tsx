...
export default function Authentication() {
    ...
    const SignUpCard = () => {
        ...
        // state: 패스워드 에러 상태
        const [isEmailError, setEamilError] = useState<boolean>(false);
                ...
                <div className='auth-jumbotron-box'>
                    <div className='auth-jumbotron-content'>
                        ...
                        <div className='auth-jumbotron-text-box'>
                            <div className='auth-jumbptron-text'>{"환영합니다."}</div>
                            <div className='auth-jumbptron-text'>{"BAGOYE BOARD 입니다."}</div>
                        </div>
                    </div>
                </div>
